...
run_operations()
{
	...
	case $KERNEL_VERSION in
		"4.18.0-rc6-exf2fs")
			...
			PERF_CMD="/home/jata/xF2FS/kernel/x86_64/linux/tools/perf/perf mem record"
			;;
		"3.18.22")
	...
	do
		...
		do
			...
			#cat /proc/stat > ${MPSTAT_FILE}_iter${i}_start.dat

			# vmstat
			#vmstat 1 > ${VMSTAT_FILE}_iter${i}.dat &
			#VMSTAT_PID=$!
			...
			# Get perf data
			mv perf.data ${OUTPUT_DIR_DEV_MODE_FS}/perf_${i}.data
		done
	done
}
