...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int dx1_rs_rx_clock : 1;
        unsigned int dx0_rs_rx_clock : 1;
        unsigned int ac_rs_rx_clock : 1;
        unsigned int dx1_rs_tx_clock : 1;
        unsigned int dx0_rs_tx_clock : 1;
        unsigned int ac_rs_tx_clock : 1;
        unsigned int dx1_rs_rx_clock_mid : 1;
        unsigned int dx0_rs_rx_clock_mid : 1;
        unsigned int ac_rs_rx_clock_mid : 1;
        unsigned int dx1_rs_tx_clock_mid : 1;
        unsigned int dx0_rs_tx_clock_mid : 1;
        unsigned int ac_rs_tx_clock_mid : 1;
        unsigned int reserved : 1;
        unsigned int clk_wr_en : 16;
    } reg;
...
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_rx_clock_START (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_rx_clock_END (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_rx_clock_START (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_rx_clock_END (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_rx_clock_START (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_rx_clock_END (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_tx_clock_START (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_tx_clock_END (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_tx_clock_START (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_tx_clock_END (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_tx_clock_START (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_tx_clock_END (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_rx_clock_mid_START (9)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_rx_clock_mid_END (9)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_rx_clock_mid_START (10)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_rx_clock_mid_END (10)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_rx_clock_mid_START (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_rx_clock_mid_END (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_tx_clock_mid_START (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx1_rs_tx_clock_mid_END (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_tx_clock_mid_START (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dx0_rs_tx_clock_mid_END (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_tx_clock_mid_START (14)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ac_rs_tx_clock_mid_END (14)
