...
#define AON_SYS_RESERVED_SIZE (0x2)
...
#define SYS_CODE_SEC_SIZE (0x11600-SYS_CODE_SEC_RESERVED_SIZE)
...
#define SYS_BSS_SEC_SIZE (0x3400-SYS_BSS_SEC_RESERVED_SIZE)
...
#endif
#define EXPOSE_STORAGE_BASE (M3_SRAM_BASE + M3_SRAM_SIZE - 0x2000)
#define EXPOSE_STORAGE_SIZE (0x800)
...
#if ((DDRC_SAVE_BASE + DDRC_SAVE_SIZE) > (EXPOSE_STORAGE_BASE + EXPOSE_STORAGE_SIZE))
