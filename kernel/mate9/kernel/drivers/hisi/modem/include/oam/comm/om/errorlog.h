...
/*****************************************************************************
 结构名    : NAS_MNTN_EVENT_STATE_STRU
 结构说明  : NAS_MNTN_EVENT_STATE_STRU信息
...
}NAS_MNTN_EVENT_STATE_STRU;

/*****************************************************************************
 结构名    : NAS_MNTN_LOG_EVENT_STATE_STRU
 结构说明  : NAS_MNTN_LOG_EVENT_STATE_STRU信息
...
typedef struct
{
    NAS_MNTN_EVENT_STATE_STRU           stEventState[NAS_MNTN_MAX_LOG_EVENT_STATE_NUM];
    VOS_UINT32                          ulExitTime;
    VOS_UINT8                           ucLatestIndex;
    VOS_UINT8                           ucReserve[3];
}NAS_MNTN_LOG_EVENT_STATE_STRU;


/*******************************************************************************
 结构名    : NAS_MNTN_TIMER_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 
*******************************************************************************/
typedef struct
{
    TIMER_HANDLE                        hTimer;                                 /* 定时器的句柄 */
    VOS_UINT32                          enTimerId;                              /* 定时器的ID */
    VOS_UINT8                           enTimerStatus;                          /* 定时器的运行状态,启动或停止 */
    VOS_UINT8                           aucReserve[3];
    VOS_UINT32                          ulParam;
}NAS_MNTN_TIMER_INFO_STRU;
