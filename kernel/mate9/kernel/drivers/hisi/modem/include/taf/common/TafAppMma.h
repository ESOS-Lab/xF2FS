...
enum TAF_MMA_MSG_TYPE_ENUM
{
    ...
    ID_TAF_MMA_IMS_REG_DOMAIN_NOTIFY,                                           /* _H2ASN_MsgChoice TAF_MMA_IMS_REG_DOMAIN_NOTIFY_STRU */

    ID_TAF_MMA_UPDATE_TYPE_C_PDP_COUNT_NOTIFY,                                  /* _H2ASN_MsgChoice TAF_MMA_C_PDP_COUNT_MAINTAIN_NOTIFY_STRU*/

    ID_TAF_MMA_COMBINED_MODE_SWITCH_IND,                                   /* _H2ASN_MsgChoice TAF_MMA_COMBINED_MODE_SWITCH_IND_STRU */

    ID_TAF_MMA_CDMA_MT_CALL_END_NTF,

    ID_TAF_MMA_IMSI_REFRESH_IND,                                                /* _H2ASN_MsgChoice TAF_MMA_IMSI_REFRESH_IND_STRU */

    ID_TAF_MMA_RESET_NTF,                                                       /* _H2ASN_MsgChoice TAF_MMA_RESET_NTF_STRU */

    ID_TAF_MMA_CDMA_ENTER_DORM_FOR_PRIOR_SYS_NTF,
...
/*****************************************************************************
 枚举名    :  MSCC_MMA_SWITCH_MODE_ENUM_UINT32
 枚举说明  :  当前组合模式
 1.日    期   : 2016年4月29日
   作    者   : y00245242
   修改内容   : 新建
