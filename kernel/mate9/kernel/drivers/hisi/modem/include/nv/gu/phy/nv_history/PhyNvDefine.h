...
#define UCOM_NV_G_MRX_GAIN_CHAN_MAX_NUM     ( 3 )                              /* MRX GAIN信道最大数目 */
...
typedef struct
{
    VOS_UINT16              uhwMrxGainOffset[UCOM_NV_G_MRX_GAIN_CTRL_MAX_NUM];  /* 每档增益偏差 */
    VOS_UINT16              uhwReserved;                                        /* 保留位 */
...
typedef struct
{
    UCOM_NV_GSM_MRX_GAIN_OFFSET_CHAN_STRU   stMrxGainOffset[UCOM_NV_G_MRX_GAIN_CHAN_MAX_NUM];   /* 3个信道，5档增益偏差 */
