...
typedef struct
{
    ...
    VOS_UINT8                           ucNghbrExtraExccedTime;                 /* TCH邻区集测量额外需要超过门限次数，才触发上报，基础迟滞策略 */
    VOS_UINT8                           ucCandExtraExccedTime;                  /* TCH候选集测量额外需要超过门限次数，才触发上报，基础迟滞策略 */
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : PM LOG模块功耗统计信息，接收信号能量强弱临界值
*****************************************************************************/
typedef struct
{
    VOS_INT16                           sLowSignalCrisisValue;                  /* PM LOG模块IDLE态接收弱信号临界值(-96) 单位0.125dB */
    VOS_INT16                           sHighSignalCrisisValue;                 /* PM LOG模块IDLE态接收强信号临界值(-48) 单位0.125dB */
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : DTS2016051108469, TCH能量报告,增强迟滞系数, 3517
*****************************************************************************/
typedef struct
{
