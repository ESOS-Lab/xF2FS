...
{
    RF_NV_MIPIDEV_UNIT_STRU mipidev_unit[16];
}RF_NV_MIPIDEV_MDM_DPM_COMM_STRU;
...
typedef struct
{
	...
	RF_NV_MIPIDEV_UNIT_STRU  mipi_ctrl;/*MIPI  配置  */
}FEM_GPIO_MIPIDEV_CTRL_STRU;

typedef struct
{
	FEM_GPIO_MIPIDEV_CTRL_STRU cfg[FEM_IO_CFG_MAX];
}NV_FEM_GPIO_MIPIDEV_CTRL_STRU;

typedef struct{
    RF_NV_MIPIDEV_UNIT_STRU mipi_ctrl[4];
}RF_NV_MIPIDEV_04CMD;
