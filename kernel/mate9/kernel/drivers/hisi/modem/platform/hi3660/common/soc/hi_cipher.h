...
#define HI_CH5_SOFTRESET_OFFSET (0x300)
#define HI_CH5_EN_OFFSET (0x304)
#define HI_CH5_CONFIG_OFFSET (0x308)
#define HI_CH5_BDQ_BADDR_OFFSET (0x30C)
#define HI_CH5_BDQ_SIZE_OFFSET (0x310)
#define HI_CH5_BDQ_PTR_OFFSET (0x314)
#define HI_CH5_BDQ_RADDR_OFFSET (0x318)
#define HI_CH5_BDQ_WADDR_OFFSET (0x31C)
#define HI_CH5_BD_NUM_OFFSET (0x320)
#define HI_CH5_INVALID_BD_NUM_OFFSET (0x324)
#define HI_CH6_SOFTRESET_OFFSET (0x380)
#define HI_CH6_EN_OFFSET (0x384)
#define HI_CH6_CONFIG_OFFSET (0x388)
#define HI_CH6_BDQ_BADDR_OFFSET (0x38C)
#define HI_CH6_BDQ_SIZE_OFFSET (0x390)
#define HI_CH6_BDQ_PTR_OFFSET (0x394)
#define HI_CH6_BDQ_RADDR_OFFSET (0x398)
#define HI_CH6_BDQ_WADDR_OFFSET (0x39C)
#define HI_CH6_BD_NUM_OFFSET (0x3A0)
#define HI_CH6_INVALID_BD_NUM_OFFSET (0x3A4)
...
#define HI_CIPHER_DEBUG21_OFFSET (0x42C)
#define HI_CIPHER_DEBUG22_OFFSET (0x430)
#define HI_CIPHER_DEBUG23_OFFSET (0x434)
#define HI_CIPHER_DEBUG24_OFFSET (0x438)
#define HI_CIPHER_DEBUG25_OFFSET (0x43C)
#define HI_CIPHER_DEBUG26_OFFSET (0x440)
#define HI_CIPHER_INT3_STATUS_OFFSET (0x444)
#define HI_CIPHER_INT3_MASK_OFFSET (0x448)
#define HI_CIPHER_INT3_MSTATUS_OFFSET (0x44C)
#define HI_CIPHER_INT4_STATUS_OFFSET (0x450)
#define HI_CIPHER_INT4_MASK_OFFSET (0x454)
#define HI_CIPHER_INT4_MSTATUS_OFFSET (0x458)
#define HI_TIMEOUT_OFFSET (0x45C)
...
#define HI_CH5_RDQ_BADDR_OFFSET (0x700)
#define HI_CH5_RDQ_SIZE_OFFSET (0x704)
#define HI_CH5_RDQ_PTR_OFFSET (0x708)
#define HI_CH5_RDQ_RADDR_OFFSET (0x70C)
#define HI_CH5_RDQ_WADDR_OFFSET (0x710)
#define HI_CH6_RDQ_BADDR_OFFSET (0x780)
#define HI_CH6_RDQ_SIZE_OFFSET (0x784)
#define HI_CH6_RDQ_PTR_OFFSET (0x788)
#define HI_CH6_RDQ_RADDR_OFFSET (0x78C)
#define HI_CH6_RDQ_WADDR_OFFSET (0x790)
...
typedef union
{
    struct
    {
        unsigned int ch0_pri : 3;
        unsigned int reserved_5 : 1;
        unsigned int ch1_pri : 3;
        unsigned int reserved_4 : 1;
        unsigned int ch2_pri : 3;
        unsigned int reserved_3 : 1;
        unsigned int ch3_pri : 3;
        unsigned int reserved_2 : 5;
        unsigned int ch5_pri : 3;
        unsigned int reserved_1 : 1;
        unsigned int ch6_pri : 3;
...
typedef union
{
    struct
    {
        unsigned int cipher_version : 32;
    } bits;
    unsigned int u32;
}HI_CIPHER_VERSION_T;
typedef union
...
typedef union
{
    struct
    {
        ...
        unsigned int ibuf_dma_len : 5;
        unsigned int dma_opt_en : 1;
...
typedef union
{
    struct
    {
        unsigned int ch_invalid_bd_num : 32;
    } bits;
    unsigned int u32;
}HI_CH5_INVALID_BD_NUM_T;
typedef union
{
    struct
    {
...
typedef union
{
    struct
    {
        ...
        unsigned int rptr : 10;
        unsigned int reserved_0 : 4;
        unsigned int ch6_bdq_empty : 1;
        unsigned int ch6_bdq_full : 1;
    } bits;
    unsigned int u32;
}HI_CH6_BDQ_PTR_T;
typedef union
...
typedef union
{
    struct
    {
        unsigned int ch6_invalid_bd_num : 32;
    } bits;
    unsigned int u32;
}HI_CH6_INVALID_BD_NUM_T;
typedef union
{
    struct
    {
        ...
        unsigned int ch5_pkt_num : 4;
        unsigned int ch6_pkt_num : 4;
...
typedef union
{
    struct
    {
        ...
        unsigned int cipher_int3 : 1;
        unsigned int cipher_int4 : 1;
...
typedef union
{
    struct
    {
        unsigned int ch5_bdq_full : 1;
        unsigned int ch5_rdq_full : 1;
        unsigned int ch5_nbd_done : 1;
        unsigned int ch5_bd_done : 1;
        unsigned int ch5_allbd_done : 1;
        unsigned int ch5_integrity_err : 1;
        unsigned int reserved_1 : 2;
        unsigned int ch6_bdq_full : 1;
        unsigned int ch6_rdq_full : 1;
        unsigned int ch6_nbd_done : 1;
        unsigned int ch6_bd_done : 1;
        unsigned int ch6_allbd_done : 1;
        unsigned int ch6_integrity_err : 1;
        unsigned int reserved_0 : 18;
    } bits;
    unsigned int u32;
}HI_CIPHER_INT3_STATUS_T;
typedef union
{
    struct
    {
...
typedef union
{
    ...
    unsigned int u32;
}HI_CIPHER_INT3_MSTATUS_T;
typedef union
{
    struct
    {
        unsigned int ch5_bdq_empty : 1;
        unsigned int ch5_rdq_empty : 1;
        unsigned int ch5_timeout : 1;
        unsigned int reserved_1 : 5;
        unsigned int ch6_bdq_empty : 1;
        unsigned int ch6_rdq_empty : 1;
        unsigned int ch6_timeout : 1;
        unsigned int reserved_0 : 21;
    } bits;
    unsigned int u32;
}HI_CIPHER_INT4_STATUS_T;
typedef union
{
    struct
    {
...
typedef union
{
    ...
    unsigned int u32;
}HI_CIPHER_INT4_MSTATUS_T;
typedef union
{
    struct
    {
        unsigned int timeout_time : 8;
        unsigned int reserved : 24;
    } bits;
    unsigned int u32;
}HI_TIMEOUT_T;
