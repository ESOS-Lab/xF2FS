...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int intr_asp_dmmu_hifi : 1;
        unsigned int intr_ocbctrl_hifi : 1;
        unsigned int asp_hdmi_int : 1;
...
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_intr_asp_dmmu_hifi_START (11)
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_intr_asp_dmmu_hifi_END (11)
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_intr_ocbctrl_hifi_START (12)
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_intr_ocbctrl_hifi_END (12)
