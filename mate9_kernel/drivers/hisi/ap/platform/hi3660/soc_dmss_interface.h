...
#define SOC_DMSS_ASI_SEC_P_RGN_MAP_ADDR(base,sec_rgns,asi_base) ((base) + (0x600+0x10*(sec_rgns)+0x800*(asi_base)))
#define SOC_DMSS_ASI_SEC_P_MID_WR_ADDR(base,sec_rgns,asi_base) ((base) + (0x608+0x10*(sec_rgns)+0x800*(asi_base)))
#define SOC_DMSS_ASI_SEC_P_MID_RD_ADDR(base,sec_rgns,asi_base) ((base) + (0x60C+0x10*(sec_rgns)+0x800*(asi_base)))
...
#define SOC_DMSS_ASI_DFX_ABNM_INF0_ADDR(base,asi_base) ((base) + (0x728+0x800*(asi_base)))
#define SOC_DMSS_ASI_DFX_ABNM_INF1_ADDR(base,asi_base) ((base) + (0x72C+0x800*(asi_base)))
#define SOC_DMSS_ASI_DFX_SEC0_ADDR(base,asi_base) ((base) + (0x730+0x800*(asi_base)))
#define SOC_DMSS_ASI_DFX_SEC1_ADDR(base,asi_base) ((base) + (0x734+0x800*(asi_base)))
#define SOC_DMSS_ASI_DFX_SEC2_ADDR(base,asi_base) ((base) + (0x738+0x800*(asi_base)))
#define SOC_DMSS_ASI_DFX_SEC3_ADDR(base,asi_base) ((base) + (0x73C+0x800*(asi_base)))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int reserved_0 : 3;
        unsigned int rtl_sec_p_rgn_num : 5;
        unsigned int reserved_1 : 19;
    } reg;
...
#define SOC_DMSS_ASI_RTL_INF3_rtl_sec_p_rgn_num_START (8)
#define SOC_DMSS_ASI_RTL_INF3_rtl_sec_p_rgn_num_END (12)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int ld_p_rgn_map : 1;
        unsigned int reserved_0 : 1;
        unsigned int ld_p_mid_rd : 1;
        unsigned int ld_p_mid_wr : 1;
...
#define SOC_DMSS_ASI_SEC_LD_SEL_ld_p_rgn_map_START (4)
#define SOC_DMSS_ASI_SEC_LD_SEL_ld_p_rgn_map_END (4)
#define SOC_DMSS_ASI_SEC_LD_SEL_ld_p_mid_rd_START (6)
#define SOC_DMSS_ASI_SEC_LD_SEL_ld_p_mid_rd_END (6)
#define SOC_DMSS_ASI_SEC_LD_SEL_ld_p_mid_wr_START (7)
#define SOC_DMSS_ASI_SEC_LD_SEL_ld_p_mid_wr_END (7)
...
typedef union
{
    ...
    struct
    {
        unsigned int p_rgn_base_addr : 16;
        unsigned int p_rgn_top_addr : 16;
    } reg;
} SOC_DMSS_ASI_SEC_P_RGN_MAP_UNION;
#endif
#define SOC_DMSS_ASI_SEC_P_RGN_MAP_p_rgn_base_addr_START (0)
#define SOC_DMSS_ASI_SEC_P_RGN_MAP_p_rgn_base_addr_END (15)
#define SOC_DMSS_ASI_SEC_P_RGN_MAP_p_rgn_top_addr_START (16)
#define SOC_DMSS_ASI_SEC_P_RGN_MAP_p_rgn_top_addr_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int p_mid_sel_wr : 32;
    } reg;
} SOC_DMSS_ASI_SEC_P_MID_WR_UNION;
#endif
#define SOC_DMSS_ASI_SEC_P_MID_WR_p_mid_sel_wr_START (0)
#define SOC_DMSS_ASI_SEC_P_MID_WR_p_mid_sel_wr_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int p_mid_sel_rd : 32;
    } reg;
} SOC_DMSS_ASI_SEC_P_MID_RD_UNION;
#endif
#define SOC_DMSS_ASI_SEC_P_MID_RD_p_mid_sel_rd_START (0)
#define SOC_DMSS_ASI_SEC_P_MID_RD_p_mid_sel_rd_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
