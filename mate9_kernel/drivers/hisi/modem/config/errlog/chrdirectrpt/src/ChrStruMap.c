...
enum STRUCT_ID_ENUM
{
    LL2_OM_VOLTE_STAT_INFO_STRU_ID	= 70,
    LMAC_OM_PRACH_CONFIG_STRU_ID	= 64,
    LMAC_OM_PREAMBLE_SPEC_NOT_MATCH_INFO_STRU_SUBEVENT	= 31,
    LPS_LOW_QUILITY_ABNORMAL_STRU_ID	= 66,
    LPS_OM_VOLTE_FAULT_AUTOAN_INFO_STRU_SUBEVENT	= 36,
    LPS_OM_VOLTE_GENERAL_STAT_INFO_STRU_SUBEVENT	= 43,
    LRRC_OM_AIR_SIGNAL_INFO_STRU_ID	= 67,
    LRRC_OM_LAYER_EVENT_INFO_STRU_ID	= 68,
    LRRC_OM_MEASRPT_INFO_ID	= 69,
    LRRC_OM_SCELL_ID_ID	= 62,
    LRRC_OM_TAC_STRU_ID	= 65,
    LRRC_OM_VOLTE_SINGLE_CALL_INFO_STRU_ID	= 53,
    LRRC_OM_VOLTE_SINGLE_FAULT_INFO_STRU_ID	= 55,
    TLL2_LMAC_PREAMBLE_SPEC_NOT_MATCH_LOG_STRU_ID	= 61,
    TLL2_OOS_INFO_STRU_SUBEVENT	= 20,
    TRRC_APP_COLLECT_TDS_FREQ_REPORT_STRU_SUBEVENT	= 22,
    TRRC_APP_CS_RELEASE_CELL_INFO_STRU_ID	= 59,
    TRRC_APP_STATE_INFO_STRU_ID	= 58,
    TRRC_CS_CALL_AIRMSG_INFO_STRU_SUBEVENT	= 27,
    TRRC_CS_CALL_CONN_REQ_INFO_STRU_SUBEVENT	= 24,
    TRRC_CS_CALL_EST_CNF_INFO_STRU_SUBEVENT	= 23,
    TRRC_CS_CALL_MM_INFO_STRU_ID	= 60,
    TRRC_OOS_INFO_STRU_SUBEVENT	= 19,
    TRRC_OUT_OF_SYNC_CELL_UPDATE_INFO_STRU_SUBEVENT	= 21,
};
const struct
{
    VOS_UINT16          EventID;
...
{
    LPS_OM_VOLTE_FAULT_AUTOAN_INFO_STRU_ALARMID,     LPS_OM_VOLTE_FAULT_AUTOAN_INFO_STRU_SUBEVENT,     1688,     50,
    {
    {FIELD_TYPE_UINT, 4},
    {FIELD_TYPE_UINT, 4},
    {FIELD_TYPE_UINT, 4},
...
{
    LRRC_VOLTE_FAULT_AUTOAN_IND_EVENTID,     0,     1688,     1,
    {
...
{
    TRRC_STATISTIC_INFO_COLLECTION_EVENTID,     0,     252,     5,
    {
