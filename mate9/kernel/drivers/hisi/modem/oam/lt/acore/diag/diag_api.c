                        ...
                        VOS_UINT32 ulLogId, VOS_UINT32 amount, ...)
{
    ...
    *(VOS_UINT32*)(ucDiagPrintData + sizeof(VOS_UINT32)) = DIAG_GET_PRINTF_LEVEL(ulModuleId);
    ...
    lTmpLen    = VOS_nsprintf_s(ucDiagPrintData + lOccupyLen, (VOS_UINT32)lSpareLen, (VOS_UINT32)lSpareLen, "%d, ", ulLogId);
    ...
    lTmpLen    = VOS_nsprintf_s(ucDiagPrintData + lOccupyLen, (VOS_UINT32)lSpareLen, (VOS_UINT32)lSpareLen, "%u, ", VOS_GetTick());
    LTE_LOG_AFFIRM(0 <= lTmpLen);
    ...
    for(i = 0; i < (VOS_INT32)paranum; i++)
    {
        ...
        lTmpLen = VOS_nsprintf_s(ucDiagPrintData + lOccupyLen, (VOS_UINT32)lSpareLen, (VOS_UINT32)lSpareLen, "%d, ", val);
        if(0 > lTmpLen)
        {
