...
#define MAX_LTE_STATE_RPT_INFO_NUM      (5)
#define IMSA_VOICE_RESULT_ABNORMAL_BASE (30)
...
enum IMSA_VOICE_MSG_ID_ENUM
{
    ...
    ID_VOICE_IMSA_DIAGNOSE_REQ                      = 0x493F,  /* BSD检查到下行语音异常时通知IMSA自检测 */
    ...
    ID_IMSA_VOICE_DIAGNOSE_CNF                      = 0x943F,  /* IMSA回复BSD自检测结果 */
...
/*****************************************************************************
 实体名称  : IMSA_VOICE_DIAGNOSE_RESULT_ENUM
 功能描述  : BSD自检测结果
*****************************************************************************/
enum IMSA_VOICE_DIAGNOSE_RESULT_ENUM
{
    IMSA_VOICE_DIAGNOSE_RESULT_ABNORMAL_NOT_FOUND       = IMSA_VOICE_RESULT_ABNORMAL_BASE + 0,
    IMSA_VOICE_DIAGNOSE_RESULT_ABNORMAL_NW_DEFINITELY   = IMSA_VOICE_RESULT_ABNORMAL_BASE + 1,
    IMSA_VOICE_DIAGNOSE_RESULT_ABNORMAL_NW_POSSIBLE     = IMSA_VOICE_RESULT_ABNORMAL_BASE + 2,
    IMSA_VOICE_DIAGNOSE_RESULT_ABNORMAL_UE_POSSIBLE     = IMSA_VOICE_RESULT_ABNORMAL_BASE + 3,

    IMSA_VOICE_DIAGNOSE_RESULT_ABNORMAL_BUTT
};
typedef VOS_UINT16 IMSA_VOICE_DIAGNOSE_RESULT_ENUM_UINT16;
...
typedef struct
{
    ...
    VOS_UINT32                          ulBitrateSet;                           /* Ims发包的码率 */
    VOS_UINT32                          ulVoiceEncrypt;                         /* 0 = not Encrypt；1 = Encrypt； */
    VOS_UCHAR                           ucModeChangeNeigh;
    VOS_UCHAR                           aucReserve[3];
...
/*****************************************************************************
 实体名称  : VOICE_IMSA_DIAGNOSE_REQ_STRU
 功能描述  : BSD检查到下行语音异常时通知IMSA接口
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                              /*_H2ASN_Skip*/
    VOS_UINT16                          usMsgId;                /* 0x49B1 */ /*_H2ASN_Skip*/
    VOS_UINT16                          usReserved;             /* 保留字段 */
    VOS_UINT16                          usEventType;            /* 语音异常类型 */
    VOS_UINT16                          usEventCause;           /* 语音异常原因, 丢包或者抖动 */
    VOS_UINT32                          ulEventStartSlice;      /* 语音异常起始时间戳 */
    VOS_UINT32                          ulEventEndSlice;        /* 语音异常终止时间戳 */
}VOICE_IMSA_DIAGNOSE_REQ_STRU;
...
typedef struct
{
    ...
    VOS_INT16                           asRsrq;
    VOS_UINT8                           ucBler;
    VOS_UINT8                           ucSensorInfo;
    VOS_UINT16                          usRsv;
}IMSA_VOICE_LTE_STATE_RPT_INFO_STRU;

/*****************************************************************************
 实体名称  : IMSA_VOICE_FAULIT_AUTOAN_FORBSD_STRU
 功能描述  : modem异常详细信息
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          enVolteCause;
    VOS_UINT16                          usRtpPktLostnum;
    VOS_UINT16                          usRtpPktLostTotalNum;
    VOS_UINT16                          usJitterMs;
    VOS_UINT8                           ucRsv;
    VOS_UINT8                           ucRsv0;
    VOS_UINT8                           ucRsv1;
    VOS_UINT8                           ucValidRptNum;
    IMSA_VOICE_LTE_STATE_RPT_INFO_STRU  astSignalInfo[MAX_LTE_STATE_RPT_INFO_NUM];
}IMSA_VOICE_FAULIT_AUTOAN_FORBSD_STRU;

/*****************************************************************************
 实体名称  : IMSA_VOICE_DIAGNOSE_CNF_STRU
 功能描述  : IMSA上报Modem 诊断结果接口
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                              /*_H2ASN_Skip*/
    VOS_UINT16                              usMsgId;                /* 0x943F1 */ /*_H2ASN_Skip*/
    IMSA_VOICE_DIAGNOSE_RESULT_ENUM_UINT16  enRslt;
    VOS_UINT32                              ulCause;
    VOS_UINT16                              usReserved;
    VOS_UINT16                              usChrReportFLag;    /* 详细参数是否上报CHR 1:上报, 0: 不上报 */
    IMSA_VOICE_FAULIT_AUTOAN_FORBSD_STRU    stAutoan;
}IMSA_VOICE_DIAGNOSE_CNF_STRU;
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT16                                  usMsgName;
