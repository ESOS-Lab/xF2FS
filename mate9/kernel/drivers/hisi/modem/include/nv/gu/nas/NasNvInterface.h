...
typedef struct
{
    ...
    VOS_UINT16                          usMinSleepTimerLen;     /* 当前阶段最短SleepTimeLen,如果usSleepTimeLen小于该值，取ucMinSleepTimerLen,用于对不同产品的定制需求 */
...
typedef struct
{
    VOS_UINT8                                               ucNoCardPowerSaveFlg;
    VOS_UINT8                                               aucRsved[3];
...
typedef struct
{
    ...
    NAS_NVIM_MODE_SELECTION_RETRY_TIMER_CTRL_STRU           stRetryTimerCtrl;
