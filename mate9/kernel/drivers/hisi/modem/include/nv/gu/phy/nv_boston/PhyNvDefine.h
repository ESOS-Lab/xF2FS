...
/* MRX */
#define UCOM_NV_G_MRX_GAIN_CTRL_MAX_NUM     ( 5 )                              /* MRX GAIN控制字命令最大数目 */
#define UCOM_NV_G_MRX_GAIN_CHAN_MAX_NUM     ( 16 )                             /* MRX GAIN信道最大数目 */
...
#define UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM          ( 8 )                       /* BODY SAR (5mm)共分8个档位 */
...
#define UCOM_WCDMA_TX_UARFCN_NUM            ( 0x10 )                            /* Tx每个频段下UARFCN个数 */
#define UCOM_WCDMA_RX_UARFCN_NUM            ( 0x10 )                            /* Rx每个频段下UARFCN个数 */
...
/* NV归一相关的参数 */
#define UCOM_GSM_DL_PATH_NUM                        ( 1 )                       /* G模下行path的个数  */
#define UCOM_GSM_UL_PATH_NUM                        ( 1 )                       /* G模上行path的个数  */

/* W下NV优化新增宏定义 */
#define W_LNA_ENABLE                                ( 1 )
#define W_LNA_DISABLE                               ( 0 )
#define W_RX_ANT_NUM                                ( 2 )
...
enum LNA_GAIN_MIPI_LEVEL
{
    ...
    LNA_GAIN_MIPI_LEVEL_2            ,
    LNA_GAIN_MIPI_LEVEL_3
};
...
/*****************************************************************************
 结构名    : UCOM_NV_WG_MRX_IQ_REV_CONTROL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : IQ接反配置
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwMrxIQExchange;                       /* MRx I/Q路交换选择，为1时交换 */
    VOS_UINT16                          uhwReserved;
}UCOM_NV_WG_MRX_IQ_REV_CONTROL_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                          uhwPaPreChargeTiming;
    VOS_UINT16                          uhwGpioPaEnableTiming;                  /* PA使能时刻，单位为Qb */
    VOS_UINT16                          uhwRampOpenTiming;                      /* APC开始爬坡时刻，单位为Qb */
    VOS_UINT16                          uhwGpioPaDisableTiming;                 /* PA关闭时刻，单位为Qb */
    VOS_UINT16                          uhwPaPreChargeDisableTiming;
    VOS_UINT16                          uhwAntSwitchCloseTiming;                /* 天线关闭时刻，单位为Qb */
    VOS_UINT16                          uhwMultiSlotRampOpenTiming;             /* 多时隙下，APC爬坡时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotGpioPaModeSetTiming;        /* 多时隙下，Pa Mode的设置时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotTxRegEnableTiming;          /* 多时隙下，GMSK，Tx Word发送时刻，单位为Qb  */
    VOS_UINT16                          uhwMultislotPaPreChargeTiming;
...
typedef struct
{
    ...
    VOS_UINT16                          uhwMultislotGpioPaModeSetTiming;        /* 多时隙下，Pa Mode的设置时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotTxRegEnableTiming;          /* 多时隙下，GMSK，Tx Word发送时刻，单位为Qb  */
    VOS_UINT16                          uhwMultislotPaVbiasTiming;
...
typedef struct
{
    ...
    VOS_UINT16                          uhwTxCmdTimer;                          /* 新增，CMD生效时刻 */
...
}UCOM_NV_GSM_TIME_CONFIG_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_EDGE_TIME_CONFIG_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : EDGE 内部TIMING 结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwPreModSymbol;                        /* 预调制符号 */
...
typedef struct
{
    UCOM_NV_GSM_POLAR_PA_RFIC_CTRL_STRU     stGsmPolarPaRficCtrl;               /* 饱和PA情况下，RFIC控制字 */
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM下BODY SAR(5mm)各档位的回退值
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwGsmSarBackoffPowerAdditional[UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM];
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : WCDMA下BODY SAR(5mm)各档位的回退值
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwWcdmaSarBackoffPowerAdditional[UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM];
...
typedef struct
{
    VOS_INT16                           ashwTxHdetFreqComp[UCOM_WCDMA_TX_UARFCN_NUM];                       /* 不同频点对功率器件影响不同，频率补偿值 */
...
typedef struct
{
    UCOM_NV_GSM_MRX_GAIN_DCOFFSET_STRU          stGsmMrxDcOffset[UCOM_NV_G_MRX_GAIN_CTRL_MAX_NUM];  /* 各个档位校准码子 */
...
typedef struct
{
    ...
    VOS_UINT16                  uhwReserved;                                    /* 保留位 */
    UCOM_NV_GSM_MRX_GAIN_STRU   stGsmMrxGain[UCOM_NV_G_MRX_GAIN_CTRL_MAX_NUM];  /* mrx 5档 */
...
typedef struct
{
    VOS_INT16               shwMrxGainOffset[UCOM_NV_G_MRX_GAIN_CTRL_MAX_NUM];  /* 每档增益偏差 */
    VOS_UINT16              uhwReserved;                                        /* 保留位 */
...
typedef struct
{
    ...
    VOS_UINT16                              uhwMrxCalChan[UCOM_NV_G_MRX_GAIN_CHAN_MAX_NUM]; /* 信道值 */
