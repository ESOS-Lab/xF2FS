...
VOS_VOID AT_ReadLTENV(VOS_VOID)
{
    ...
    TAF_MEM_SET_S(pstUECapability, sizeof(LRRC_NV_UE_EUTRA_CAP_STRU), 0x00, sizeof(LRRC_NV_UE_EUTRA_CAP_STRU));
...
VOS_VOID AT_ReadReleaseInfo(VOS_VOID)
{
    ...
    TAF_MEM_SET_S(&g_stReleaseInfo, sizeof(g_stReleaseInfo), 0x00, sizeof(g_stReleaseInfo));
