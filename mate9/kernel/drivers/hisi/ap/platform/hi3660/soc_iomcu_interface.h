...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int sel_ftimer_clk : 1;
        unsigned int clk_ftimer_stat : 1;
    } reg;
...
#define SOC_IOMCU_CLK_SEL_sel_ftimer_clk_END (30)
#define SOC_IOMCU_CLK_SEL_clk_ftimer_stat_START (31)
#define SOC_IOMCU_CLK_SEL_clk_ftimer_stat_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOMCU_CFG_DIV1_ftimer_div0_START (4)
#define SOC_IOMCU_CFG_DIV1_ftimer_div0_END (5)
#define SOC_IOMCU_CFG_DIV1_ftimer_div1_START (6)
#define SOC_IOMCU_CFG_DIV1_ftimer_div1_END (7)
#define SOC_IOMCU_CFG_DIV1_ftimer_div2_START (8)
#define SOC_IOMCU_CFG_DIV1_ftimer_div2_END (9)
#define SOC_IOMCU_CFG_DIV1_ftimer_div3_START (10)
#define SOC_IOMCU_CFG_DIV1_ftimer_div3_END (11)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int iomcu_clken1_5ftimer : 1;
...
#define SOC_IOMCU_CLKEN1_iomcu_clken1_5ftimer_START (5)
#define SOC_IOMCU_CLKEN1_iomcu_clken1_5ftimer_END (5)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int iomcu_clkdis1_5ftimer : 1;
        unsigned int reserved : 26;
    } reg;
...
#define SOC_IOMCU_CLKDIS1_iomcu_clkdis1_5ftimer_START (5)
#define SOC_IOMCU_CLKDIS1_iomcu_clkdis1_5ftimer_END (5)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int iomcu_clkstat1_5ftimer : 1;
        unsigned int reserved : 26;
    } reg;
...
#define SOC_IOMCU_CLKSTAT1_iomcu_clkstat1_5ftimer_START (5)
#define SOC_IOMCU_CLKSTAT1_iomcu_clkstat1_5ftimer_END (5)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
