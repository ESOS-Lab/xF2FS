...
#define SOC_ASP_IPC_NS_MBX_SOURCE_source_END (4)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_DSET_dset_END (4)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_SEND_send_END (4)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
