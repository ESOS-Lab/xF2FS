...
#define F2FS_IOC_START_ATOMIC_WRITE_FILES	_IO(F2FS_IOCTL_MAGIC, 3)
#define F2FS_IOC_COMMIT_ATOMIC_WRITE_FILES	_IO(F2FS_IOCTL_MAGIC, 4)
#define F2FS_IOC_START_VOLATILE_WRITE	_IO(F2FS_IOCTL_MAGIC, 5)
#define F2FS_IOC_RELEASE_VOLATILE_WRITE	_IO(F2FS_IOCTL_MAGIC, 6)
#define F2FS_IOC_ABORT_VOLATILE_WRITE	_IO(F2FS_IOCTL_MAGIC, 7)
#define F2FS_IOC_GARBAGE_COLLECT	_IO(F2FS_IOCTL_MAGIC, 8)
#define F2FS_IOC_WRITE_CHECKPOINT	_IO(F2FS_IOCTL_MAGIC, 9)
#define F2FS_IOC_DEFRAGMENT		_IO(F2FS_IOCTL_MAGIC, 10)
#define F2FS_IOC_MOVE_RANGE		_IOWR(F2FS_IOCTL_MAGIC, 11,	\
...
/* Cheon - 161208 */
void create_CRC_table(unsigned long);
